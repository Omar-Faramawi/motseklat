...
<html>
    <head>
        ...
        <?php if ($bike != NULL) { ?>
            <title><?= $this->config->item('website_name') . ' | ' . $bike->title ?></title>
            <meta name="keywords" content="<?= $bike->title ?>">
            <meta name="description" content="<?= character_limiter(strip_tags(preg_replace('/(<[^>]+) style=".*?"/i', '$1', $bike->description)), 300) ?>">
            <meta property="og:title" content="<?php echo $this->config->item('website_name') . ' | ' . $bike->title; ?>" />
            <meta property="og:image" content="<?php echo base_url('uploads/bikes/small/' . $bike->bike_picture_1) ?>" />
                        ...
                        <div class="row">
                            <div class="cell-12">
                                ...
                                <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                                    <span class="bold">أنت الأن داخل:</span><a href="#">الرئيسية</a><span class="line-separate">/</span><span>تفاصيل الإعلان</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sectionWrapper">
                    <div class="container">
                        <div class="row">
                            <div class="cell-9">
                                <!-- Post Details Start -->
                                <?php $this->load->view('front_end/includes/bike_details'); ?>
                                <!-- Post Details End --> 
                            </div>
