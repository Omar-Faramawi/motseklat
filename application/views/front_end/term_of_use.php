            ...
            <div id="contentWrapper">
                <div class="page-title title-5">
                    <div class="container">
                        <div class="row">
                            <div class="cell-12">
                                <h1 class="fx" data-animate="fadeInLeft">سياسة <span> الإستخدام</span></h1>
                                <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                                    <span class="bold">أنت الأن داخل:</span><a href="#">الرئيسية</a><span class="line-separate">/</span><span>سياسة الإستخدام</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="cell-9">
                                ...
                                <!-- wide-sidebar-ads end -->
                                <br/>

                                <!-- Post Details Start -->
                                <?php $this->load->view('front_end/includes/term_of_use_content'); ?>
                                <!-- Post Details End --> 
                            </div>
