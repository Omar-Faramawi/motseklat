...
<html>
    <head>
        ...
        <title><?= $this->config->item('website_name') . '| قطع غيار ومعدات' ?></title>
        ...
        <meta name="keywords" content="ترفية, شراء متسيكل, إطارات, الوطن العربي, تجار, وكلاء, عروضات, دراجات, دراجات نارية, متسيكلات">
            ...
            <div id="contentWrapper">
                <div class="page-title title-3">
                    <div class="container">
                        <div class="row">
                            <div class="cell-12">
                                <h1 class="fx" data-animate="fadeInLeft"> جميع<span> الملحقات</span></h1>
                                <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                                    <span class="bold">أنت الأن هنا:</span><a href="#">الرئيسية</a><span class="line-separate">/</span><span>جميع العروض</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sectionWrapper">
                    <div class="container">
                        <div class="row">
                            <div class="cell-9">
                                <?php $this->load->view('front_end/includes/all_products'); ?>
                            ...
                            <aside class="cell-3 left-shop">
                                <div class="widget fx" data-animate="fadeInRight">
                                    ...
                                    <div class="widget-content">
                                        <form action="<?= base_url('home/products/') ?>" method="get" name="search_products" id="search_products">
                                            <ul id="accordion" class="accordion">
                                                <li>
                                                    ...
                                                    <div class="accordion-panel active">
                                                        ...
                                                        <div class="control-group">
                                                            <label class="control-label">قطعه خاصة بشركة</label>
                                                            <div class="controls">
                                                        ...
                                                        <div class="control-group">
                                                            <label class="control-label">مختص في مودل</label>
                                                            <div class="controls">
