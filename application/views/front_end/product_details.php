...
<html>
    <head>
        ...
        <?php if ($product != NULL) { ?>
            <title><?= $this->config->item('website_name') . ' | ' . $product->title ?></title>
            <meta name="keywords" content="<?= $product->title ?>">
            <meta name="description" content="<?= character_limiter(strip_tags(preg_replace('/(<[^>]+) style=".*?"/i', '$1', $product->description)), 300) ?>">
            <meta property="og:title" content="<?php echo $this->config->item('website_name') . ' | ' . $product->title; ?>" />
            <meta property="og:image" content="<?php echo base_url('uploads/products/small/' . $product->product_picture_1) ?>" />
            ...
            <div id="contentWrapper">
                <div class="page-title title-3">
                    <div class="container">
                        <div class="row">
                            <div class="cell-12">
                                <h1 class="fx" data-animate="fadeInLeft">تفاصيل<span> الملحق</span></h1>
                ...
                <div class="sectionWrapper">
                    <div class="container">
                        <div class="row">
                            <div class="cell-9">
                                <!-- Post Details Start -->
                                <?php $this->load->view('front_end/includes/product_details'); ?>
                                <!-- Post Details End --> 
                            </div>
