...
<html>
    <head>
        ...
        <title><?= $this->config->item('website_name') . '| طلبات الشراء' ?></title>
        <meta name="description" content="تصفح أحدث طلبات الشراء من الدراجات النارية، أو اعرض دراجتك النارية للبيع على موتسيكلات ، كما تستطيع الضغط على الدراجة النارية التى تود شرائها للاطلاع على كافة التفاصيل والمواصفات والسعر الخاص بها، وكذلك مشاهدة صورها المعروضة .. أو اجراء بحث متقدم لعرض المزيد والمزيد من النتائج. ">
        <meta name="keywords" content="إعلانات, أحداث, سباق, ترفية, شراء متسيكل,بيع, العربي, الوطن العربي, تجار, وكلاء, عروضات, دراجات, دراجات نارية, متسيكلات">
            ...
            <div id="contentWrapper">
                <div class="page-title title-4">
                    <div class="container">
                        <div class="row">
                            <div class="cell-12">
                                <h1 class="fx" data-animate="fadeInLeft">جميع <span> الإعلانات</span></h1>
                                <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                                    <span class="bold">أنت الأن داخل:</span><a href="#">الرئيسية</a><span class="line-separate">/</span><span>جميع طلبات الشراء</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sectionWrapper">
                    <div class="container">
                        <div class="row">
                            <div class="cell-9">
                                <?php $this->load->view('front_end/includes/all_orders'); ?>
                            ...
                            <aside class="cell-3 left-shop">
                                <div class="widget fx" data-animate="fadeInRight">
                                    ...
                                    <div class="widget-content">
                                        <form action="<?= base_url('home/supplies/') ?>" method="get" name="search_supplies" id="search_supplies">
