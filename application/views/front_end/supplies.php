...
<html>
    <head>
        ...
        <title><?= $this->config->item('website_name') . '| الإعلانات' ?></title>
            ...
            <div id="contentWrapper">
                        ...
                        <div class="row">
                            <div class="cell-12">
                                ...
                                <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                                    <span class="bold">أنت الأن داخل:</span><a href="#">الرئيسية</a><span class="line-separate">/</span><span>جميع الإعلانات</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sectionWrapper">
                    <div class="container">
                        <div class="row">
                            <div class="cell-9">
                                <?php $this->load->view('front_end/includes/all_supplies'); ?>
