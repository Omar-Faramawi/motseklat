...
<html>
    <head>
        ...
        <?php if ($offer != NULL) { ?>
            <title><?= $this->config->item('website_name') . ' | ' . $offer->title ?></title>
            <meta name="keywords" content="<?= $offer->title ?>">
            <meta name="description" content="<?= character_limiter(strip_tags(preg_replace('/(<[^>]+) style=".*?"/i', '$1', $offer->description)), 300) ?>">
            <meta property="og:title" content="<?php echo $this->config->item('website_name') . ' | ' . $offer->title; ?>" />
            <meta property="og:image" content="<?php echo base_url('uploads/bikes/small/' . $offer->bike_picture_1) ?>" />
        ...
        <?php } else { ?>
            <title><?= $this->config->item('website_name') . '| ' . 'تفاصيل الإعلان' ?></title>
        <?php } ?>
            ...
            <div id="contentWrapper">
                <div class="page-title title-1">
                    <div class="container">
                        <div class="row">
                            <div class="cell-12">
                                <h1 class="fx" data-animate="fadeInLeft">تفاصيل<span> العرض</span></h1>
                                <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                                    <span class="bold">أنت الأن داخل:</span><a href="#">الرئيسية</a><span class="line-separate">/</span><span>تفاصيل العرض</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sectionWrapper">
                    <div class="container">
                        <div class="row">
                            <div class="cell-9">
                                <!-- Post Details Start -->
                                <?php $this->load->view('front_end/includes/offer_details'); ?>
                                <!-- Post Details End --> 
                            </div>
