...
<html>
    <head>
        ...
        <title><?= $this->config->item('website_name').'| الأعضاء' ?></title>
            ...
            <div id="contentWrapper">
                <div class="page-title title-6">
                    <div class="container">
                        <div class="row">
                            <div class="cell-12">
                                <h1 class="fx" data-animate="fadeInLeft">جميع<span> الأعضاء</span></h1>
                                <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                                    <?php if (isset($user_type_name) and $user_type_name != NULL) { ?>
                                        <span class="bold">أنت الأن داخل:</span><a href="<?= base_url('home') ?>">الرئيسية</a><span class="line-separate">/</span><a href="#">الأعضاء</a><span class="line-separate">/</span><span><?= $user_type_name ?></span>
                                        <?php
                                    } else {
                                        ?>
                                        <span class="bold">أنت الأن داخل:</span><a href="<?= base_url('home') ?>">الرئيسية</a><span class="line-separate">/</span><span>جميع الأعضاء</span>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="sectionWrapper">
                    <div class="container">
                        <div class="row">
                            <!-- all articles Start -->
                            <?php $this->load->view('front_end/includes/members_list'); ?>
                            <!-- all articles End -->
