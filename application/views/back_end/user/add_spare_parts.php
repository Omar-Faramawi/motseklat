...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com -  إضافة قطع غيار جديدة</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    يمكنك إضافة قطع غيار جديدة
                                </div>
                                <div class="panel-body">
                                    <h2><i class="fa fa-pencil-square teal"></i> إضافة قطع غيار</h2>
                                    <hr>
                                    <form action="#" enctype="multipart/form-data" role="form" id="add_spare_parts">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Start Alert Message -->
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div  class="fileupload fileupload-new col-md-6" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail"><img class="upload-pic-1" />
                                                    </div>
...
//                FormValidator.init();
            ...
            $("#add_spare_parts").submit(function () {
                $('.loader-img').show();
                $('#submit-btn').hide();
                var formData = new FormData($(this)[0]);
                $.ajax({
                    url: '<?php echo base_url() . "user/profile/do_add_spare_parts/"; ?>',
                    type: 'POST',
                    data: formData,
                    dataType: "JSON",
            ...
            $('#add_spare_parts #manufacturer_id').change(function () {
                $('#add_bike #model_id').empty();
                $.post('<?php echo base_url('user/profile/get_models_by_manufacturer/') ?>', {"manufacturer_id": $('#add_spare_parts #manufacturer_id').val()}, function (data) {
                    $.each(data.models, function (index, element) {
                        $('#add_spare_parts #model_id').append('<option value="' + element.id + '">' + element.name + '</option>');
                    });
                }, "json");
            });
        </script>
