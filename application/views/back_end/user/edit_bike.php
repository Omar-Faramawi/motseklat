...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - تعديل بيانات الإعلان</title>
        <!-- start: META -->
        <meta charset="utf-8" />
    ...
    <body class="rtl">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    يمكنك تعديل بيانات الإعلان
                                </div>
                                <div class="panel-body">
                                    <h2><i class="fa fa-pencil-square teal"></i> تعديل الإعلان</h2>
                                    <hr>
                                    <form action="#" enctype="multipart/form-data" role="form" id="edit_bike">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Start Alert Message -->
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="manufacturer_id" name="manufacturer_id" class="form-control search-select">
                                                        ...
                                                        <?php foreach ($manufacturers as $manufacturer) { ?>
                                                            <option <?php
                                                            if (!(strcmp($manufacturer->id, $bike->manufacturer_id))) {
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="model_id" name="model_id" class="form-control search-select">
                                                        ...
                                                        <?php foreach ($models as $model) { ?>
                                                            <option <?php
                                                            if (!(strcmp($bike->model_id, $model->id))) {
                                                                echo "selected=\"selected\"";
                                                            }
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="bike_status" class="form-control search-select">
                                                        <option <?php
                                                        if (!(strcmp($bike->bike_status, 1))) {
                                                            echo "selected=\"selected\"";
                                                        }
                                                        ?> value="1">جديد</option>
                                                        <option <?php
                                                        if (!(strcmp($bike->bike_status, 2))) {
                                                            echo "selected=\"selected\"";
                                                        }
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label class="control-label">
                                                        اللون<span class="symbol required"></span>
                                                    </label>
                                                    <select name="color" class="form-control search-select">
                                                        <option value="">&nbsp;</option>
                                                        <option <?php if (!(strcmp($bike->color, 0))) {echo "selected=\"selected\"";}?> value="0">غير ذلك</option>
                                                        <option <?php if (!(strcmp($bike->color, 1))) {echo "selected=\"selected\"";}?> value="1">أزرق</option>
                                                        <option <?php if (!(strcmp($bike->color, 2))) {echo "selected=\"selected\"";}?> value="2">أحمر</option>
                                                        <option <?php if (!(strcmp($bike->color, 3))) {echo "selected=\"selected\"";}?> value="3">أسود</option>
                                                        <option <?php if (!(strcmp($bike->color, 4))) {echo "selected=\"selected\"";}?> value="4">رمادي</option>
                                                        <option <?php if (!(strcmp($bike->color, 5))) {echo "selected=\"selected\"";}?> value="5">أبيض</option>
                                                        <option <?php if (!(strcmp($bike->color, 6))) {echo "selected=\"selected\"";}?> value="6">برتقالي</option>
                                                        <option <?php if (!(strcmp($bike->color, 7))) {echo "selected=\"selected\"";}?> value="7">ذهبي</option>
                                                        <option <?php if (!(strcmp($bike->color, 8))) {echo "selected=\"selected\"";}?> value="8">فضي</option>
														<option <?php if (!(strcmp($bike->color, 9))) {echo "selected=\"selected\"";}?> value="9">أخضر</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label">
                                                    ...
                                                    <input type="text" class="form-control" name="mileage" value="<?= $bike->mileage ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label">
                                                        تاريخ الصنع<span class="symbol required"></span>
                                                    </label>
                                                    <select name="production_date" id="form-field-select-3" class="form-control search-select">
                                                        <option value="<?= $bike->production_date ?>" selected="selected"><?= $bike->production_date ?></option>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="currency_id" name="currency_id" class="form-control search-select">
                                                        ...
                                                        <?php foreach ($currencies as $currency) { ?>
                                                            <option <?php
                                                            if (!(strcmp($currency->id, $bike->currency_id))) {
                                                                echo "selected=\"selected\"";
                                                            }
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select class="form-control search-select" name="engine">
                                                        ...
                                                        <?php foreach ($engines as $engine) { ?>
                                                            <option <?php if (!(strcmp($bike->engine, $engine->id))) {echo "selected=\"selected\"";}?> value="<?=$engine->id?>"><?=$engine->capacity?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="city_id" id="city_id" class="form-control">
                                                        <?php foreach ($cities as $city) { ?>
                                                            <option <?php
                                                            if (!(strcmp($bike->city_id, $city->id))) {
                                                                echo "selected=\"selected\"";
                                                            }
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="fileupload fileupload-new col-md-6" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?= ($bike->bike_picture_1) ? base_url('uploads/bikes/thumbs/' . $bike->bike_picture_1) : base_url('assets/back_end/images/upload-pic-1.png') ?>" alt="<?= $bike->title ?>"/>
                                                    </div>
                                                ...
                                                <div class="fileupload fileupload-new col-md-6" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?= ($bike->bike_picture_2) ? base_url('uploads/bikes/thumbs/' . $bike->bike_picture_2) : base_url('assets/back_end/images/upload-pic-2.png') ?>" alt="<?= $bike->title ?>"/>
                                                    </div>
                                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                                    <div>
                                                        <span class="btn btn-light-grey btn-file"><span class="fileupload-new"><i class="fa fa-picture-o"></i> إختيار صورة</span><span class="fileupload-exists"><i class="fa fa-picture-o"></i> تغيير</span>
                                                ...
                                                <div class="fileupload fileupload-new col-md-6" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?= ($bike->bike_picture_3) ? base_url('uploads/bikes/thumbs/' . $bike->bike_picture_3) : base_url('assets/back_end/images/upload-pic-2.png') ?>" alt="<?= $bike->title ?>"/>
                                                    </div>
                                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                                    <div>
                                                        <span class="btn btn-light-grey btn-file"><span class="fileupload-new"><i class="fa fa-picture-o"></i> إختيار صورة</span><span class="fileupload-exists"><i class="fa fa-picture-o"></i> تغيير</span>
                                                ...
                                                <div class="fileupload fileupload-new col-md-6" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?= ($bike->bike_picture_4) ? base_url('uploads/bikes/thumbs/' . $bike->bike_picture_4) : base_url('assets/back_end/images/upload-pic-2.png') ?>" alt="<?= $bike->title ?>"/>
                                                    </div>
                                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                                    <div>
                                                        <span class="btn btn-light-grey btn-file"><span class="fileupload-new"><i class="fa fa-picture-o"></i> إختيار صورة</span><span class="fileupload-exists"><i class="fa fa-picture-o"></i> تغيير</span>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" class="autosize form-control" id="form-field-24" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 69px;"><?= $bike->description ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
        ...
        <script>
            ...
            $("#edit_bike").submit(function () {
                $('.loader-img').show();
                $('#submit-btn').hide();
                var formData = new FormData($(this)[0]);
                $.ajax({
                    url: '<?php echo base_url() . "user/profile/do_edit_bike/"; ?>',
                    type: 'POST',
                    data: formData,
                    dataType: "JSON",
            ...
            $('#edit_bike #manufacturer_id').change(function () {
                $('#edit_bike #model_id').empty();
                $.post('<?php echo base_url('user/profile/get_models_by_manufacturer/') ?>', {"manufacturer_id": $('#edit_bike #manufacturer_id').val()}, function (data) {
                    $.each(data.models, function (index, element) {
                        $('#edit_bike #model_id').append('<option value="' + element.id + '">' + element.name + '</option>');
                    });
                }, "json");
            });
        </script>
