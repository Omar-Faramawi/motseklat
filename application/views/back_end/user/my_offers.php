...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - العروضات</title>
        <!-- start: META -->
        <meta charset="utf-8" />
    ...
    <body class="rtl">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    جدول يحتوي على جميع العروضات الخاصة بي
                                </div>
                            ...
                            <div class="modal fade" id="remove_offer" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            هل تريد بالتأكيد حذف هذا العرض  ؟
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                إغلاق
                                            </button>
                                            <button type="button" onclick="remove_offer()" class="btn btn-primary">
                                                موافق
                                            </button>
                                        </div>
                                    </div>
        ...
        <script>
                                                ...
                                                function remove_offer() {
                                                    $.ajax({
                                                        type: "POST",
                                                        url: '<?php echo base_url() . "user/profile/remove_offer/"; ?>',
                                                        data: {
                                                            offer_id: curr_id
                                                        },
                                                        dataType: "json",
                                                ...
                                                var runDataTable = function () {
                                                    var oTable = $('#sample_1').dataTable({
                                                        ...
                                                        "bProcessing": true,
                                                        "bServerSide": true,
                                                        "sAjaxSource": '<?php echo base_url("user/profile/get_my_offers/"); ?>',
                                                        "iDisplayStart ": 10,
                                                        "oLanguage": {
