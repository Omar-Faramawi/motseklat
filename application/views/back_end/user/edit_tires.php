...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - تعديل بيانات الإطار</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    يمكنك تعديل بيانات الإطار
                                </div>
                                <div class="panel-body">
                                    <h2><i class="fa fa-pencil-square teal"></i> تعديل الإطار </h2>
                                    <hr>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="type_id" name="type_id" class="form-control search-select">
                                                        ...
                                                        foreach ($products_types as $type) {?>
                                                            <option <?php if (!(strcmp($product->type_id, $type->id))) {echo "selected=\"selected\"";}?> value="<?= $type->id ?>"><?= $type->name ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="type_id" name="size" class="form-control search-select">
                                                        ...
                                                        <?php for($i=100; $i <= 300; $i+=10) {?>
                                                                <option <?php if (!(strcmp($product->size, $i))) { echo "selected=\"selected\"";}?> value="<?= $i ?>"><?= $i ?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6">
...
//                FormValidator.init();
            ...
            $('#edit_product #manufacturer_id').change(function () {
                $('#add_bike #model_id').empty();
                $.post('<?php echo base_url('user/profile/get_models_by_manufacturer/') ?>', {"manufacturer_id": $('#edit_product #manufacturer_id').val()}, function (data) {
                    $.each(data.models, function (index, element) {
                        $('#edit_product #model_id').append('<option value="' + element.id + '">' + element.name + '</option>');
                    });
                }, "json");
            });
        </script>
