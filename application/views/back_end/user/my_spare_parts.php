...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - قطع الغيار</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    جدول يحتوي على جميع قطع الغيار
                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            هل تريد بالتأكيد حذف هذه القطعة  ؟
                                        </div>
        ...
        <script>
                                                ...
                                                var runDataTable = function () {
                                                    var oTable = $('#sample_1').dataTable({
                                                        ...
                                                        "sAjaxSource": '<?php echo base_url(); ?>user/profile/get_my_spare_parts/',
                                                        "iDisplayStart ": 10,
                                                        "oLanguage": {
