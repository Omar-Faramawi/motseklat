...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - المعارض/الفروع الخاصة بي</title>
        <!-- start: META -->
        <meta charset="utf-8" />
    ...
    <body class="rtl">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    جدول يحتوي على جميع المعارض/الفروع الخاصة بي
                                </div>
                            ...
                            <div class="modal fade" id="remove_center" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" onclick="remove_center()" class="btn btn-primary">
                                                موافق
                                            </button>
                                        </div>
                                    </div>
        ...
        <script>
                                                ...
                                                function remove_center() {
                                                    $.ajax({
                                                        type: "POST",
                                                        url: '<?php echo base_url("user/profile/remove_center/"); ?>',
                                                        data: {
                                                            center_id: curr_id
                                                        },
                                                        dataType: "json",
                                                ...
                                                var runDataTable = function () {
                                                    var oTable = $('#sample_1').dataTable({
                                                        ...
                                                        "sAjaxSource": '<?php echo base_url("user/profile/get_my_centers/"); ?>',
                                                        "iDisplayStart ": 10,
                                                        "oLanguage": {
