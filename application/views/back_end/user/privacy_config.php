...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - إعدادات الخصوصية</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    يمكنك تعديل بيانات الخصوصية
                                </div>
                                <div class="panel-body">
                                    <form action="#" enctype="multipart/form-data" role="form" id="privacy_config">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Start Alert Message -->
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="sample-table-1">
                                                <tbody>
                                                    <tr>
                                                        <td>اظهار رقم الموبايل في الاعلان </td>
                                                        <td>
                                                            <label class="radio-inline">
                                                                <input type="radio" class="green" <?php
                                                                if (!(strcmp($config->show_mobile, 1))) {
                                                                    echo "checked=\"checked\"";
                                                                }
                                                                ?> value="1" name="show_mobile">
                                                                موافق
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" class="red" <?php
                                                                if (!(strcmp($config->show_mobile, 0))) {
                                                                    echo "checked=\"checked\"";
                                                                }
                                                                ?> value="0" name="show_mobile">
                                                                غير موافق
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>تلقي رسائل من الراغبين في الشراء على صندوق مراسلاتك في الموقع</td>
                                                        <td>
                                                            <label class="radio-inline">
                                                                <input type="radio" class="green" <?php
                                                                if (!(strcmp($config->msg_from_buyers, 1))) {
                                                                    echo "checked=\"checked\"";
                                                                }
                                                                ?> value="1" name="msg_from_buyers">
                                                                موافق
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" class="red" <?php
                                                                if (!(strcmp($config->msg_from_buyers, 0))) {
                                                                    echo "checked=\"checked\"";
                                                                }
                                                                ?> value="0" name="msg_from_buyers">
                                                                غير موافق
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>تلقي بريد من الاعضاء على صندوق مراسلاتك في الموقع </td>
                                                        <td>
                                                            <label class="radio-inline">
                                                                <input type="radio" class="green" <?php
                                                                if (!(strcmp($config->msg_from_members, 1))) {
                                                                    echo "checked=\"checked\"";
                                                                }
                                                                ?> value="1" checked="checked" name="msg_from_members">
                                                                موافق
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" class="red" <?php
                                                                if (!(strcmp($config->msg_from_members, 0))) {
                                                                    echo "checked=\"checked\"";
                                                                }
                                                                ?> value="0" name="msg_from_members">
                                                                غير موافق
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>تلقي رسائل من ادارة الموقع  </td>
                                                        <td>
                                                            <label class="radio-inline">
                                                                <input type="radio" class="green" <?php
                                                                if (!(strcmp($config->msg_from_admin, 1))) {
                                                                    echo "checked=\"checked\"";
                                                                }
                                                                ?> value="1" name="msg_from_admin">
                                                                موافق
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" class="red" <?php
                                                                if (!(strcmp($config->msg_from_admin, 0))) {
                                                                    echo "checked=\"checked\"";
                                                                }
                                                                ?> value="0" name="msg_from_admin">
                                                                غير موافق
                                                            </label>
                                                        </td>
                                                    </tr>
...
//                FormValidator.init();
            ...
            $("#privacy_config").submit(function () {
                var formData = new FormData($(this)[0]);
                $.ajax({
                    url: '<?php echo base_url() . "user/profile/update_privacy_config/"; ?>',
                    type: 'POST',
                    data: formData,
                    dataType: "JSON",
