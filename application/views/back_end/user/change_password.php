...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - تغيير كلمة المرور</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    يمكنك تغيير كلمة المرور
                                </div>
                                <div class="panel-body">
                                    <h2><i class="fa fa-pencil-square teal"></i>  تغيير كلمة المرور </h2>
                                    <hr>
                                    <form action="#" class="col-sm-6" enctype="multipart/form-data" role="form" id="change_password">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Start Alert Message -->
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">
                                                        كلمة المرور القديمة<span class="symbol required"></span>
                                                    </label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">
                                                        كلمة المرورالجديدة <span class="symbol required"></span>
                                                    </label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">
                                                        تأكيد كلمة المرور الجديدة <span class="symbol required"></span>
                                                    </label>
                                    ...
                                    <div class="col-sm-6">
                                        <!-- start 336x280 ad -->
                                        <?php $this->load->view('front_end/ads/336x280'); ?>
                                        <!-- end 336x280 ad -->
                                    </div>
                                </div>
                            </div>
...
//                FormValidator.init();
            ...
            $("#change_password").submit(function () {
                ...
                $.ajax({
                    url: '<?php echo base_url() . "user/profile/do_change_password/"; ?>',
                    type: 'POST',
                    data: formData,
                    dataType: "JSON",
