...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - الملحقات</title>
        <!-- start: META -->
        <meta charset="utf-8" />
    ...
    <body class="rtl">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="modal fade" id="remove_product" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            هل تريد بالتأكيد حذف هذا الملحق  ؟
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                إغلاق
                                            </button>
                                            <button type="button" onclick="remove_product()" class="btn btn-primary">
                                                موافق
                                            </button>
                                        </div>
                                    </div>
        ...
        <script src="<?= base_url('assets/feront_end/js/jquery.simpleWeather.min.js'); ?>" type="text/javascript"></script>
        ...
        <script>
                                                ...
                                                function remove_product() {
                                                    $.ajax({
                                                        type: "POST",
                                                        url: '<?php echo base_url("user/profile/remove_product/"); ?>',
                                                        data: {
                                                            product_id: curr_id
                                                        },
                                                        dataType: "json",
                                                ...
                                                var runDataTable = function () {
                                                    var oTable = $('#sample_1').dataTable({
                                                        ...
                                                        "sAjaxSource": '<?php echo base_url(); ?>user/profile/get_my_accessories/',
                                                        "iDisplayStart ": 10,
                                                        "oLanguage": {
