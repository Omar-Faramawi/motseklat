...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - معدات أمن وسلامة</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    جدول يحتوي على جميع معدات الأمن والسلامة
                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            هل تريد بالتأكيد حذف هذة المعدات  ؟
                                        </div>
        ...
        <script>
                                                ...
                                                var runDataTable = function () {
                                                    var oTable = $('#sample_1').dataTable({
                                                        ...
                                                        "sAjaxSource": '<?php echo base_url(); ?>user/profile/get_my_safty_equipments/',
                                                        "iDisplayStart ": 10,
                                                        "oLanguage": {
