...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - إضافة بيانات المعرض/الفرع</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    يمكنك إضافة بيانات معرض/فرع جديد
                                </div>
                                <div class="panel-body">
                                    <h2><i class="fa fa-pencil-square teal"></i> إضافة بيانات المعرض/الفرع</h2>
                                    <hr>
                                    <form action="#" enctype="multipart/form-data" role="form" id="add_center">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Start Alert Message -->
...
//                FormValidator.init();
            ...
            $("#add_center").submit(function () {
                $('.loader-img').show();
                $('#submit-btn').hide();
                var formData = new FormData($(this)[0]);
                $.ajax({
                    url: '<?php echo base_url() . "user/profile/do_add_center/"; ?>',
                    type: 'POST',
                    data: formData,
                    dataType: "JSON",
