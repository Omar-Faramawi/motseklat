...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - تعديل بيانات الملحق</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    يمكنك تعديل بيانات الملحق
                                </div>
                                <div class="panel-body">
                                    <h2><i class="fa fa-pencil-square teal"></i> تعديل الملحق</h2>
                                    <hr>
                                    <form action="#" enctype="multipart/form-data" role="form" id="edit_product">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Start Alert Message -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">
                                                        إسم الملحق<span class="symbol required"></span>
                                                    </label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="manufacturer_name" value="<?= $product->manufacturer_name ?>" />
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label class="control-label">
                                                        التصنيف  <span class="symbol required"></span>
                                                    </label>
                                                    <select name="category_id" id="city_id" class="form-control">
                                                        <?php foreach ($categories as $category) { ?>
                                                            <option <?php
                                                            if (!(strcmp($product->category_id, $category->id))) {
                                                                echo "selected=\"selected\"";
                                                            }
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">
                                                        المنطقة بالتحديد<span class="symbol required"></span>
                                                    </label>
                                                    <input type="text" class="form-control" name="full_address" value="<?= $product->full_address ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <label class="col-md-12">
                                                    قم بإختيار صورة الملحق
                                                </label>
                                                <div class="fileupload fileupload-new col-md-6" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?= ($product->product_picture_1) ? base_url('uploads/products/thumbs/' . $product->product_picture_1) : base_url('assets/back_end/images/upload-pic-1.png') ?>" alt="<?= $product->name ?>"/>
                                                    </div>
                                                ...
                                                <div class="fileupload fileupload-new col-md-6" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?= ($product->product_picture_2) ? base_url('uploads/products/thumbs/' . $product->product_picture_2) : base_url('assets/back_end/images/upload-pic-2.png') ?>" alt="<?= $product->name ?>"/>
                                                    </div>
                                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                                    <div>
                                                        <span class="btn btn-light-grey btn-file"><span class="fileupload-new"><i class="fa fa-picture-o"></i> إختيار صورة</span><span class="fileupload-exists"><i class="fa fa-picture-o"></i> تغيير</span>
                                                ...
                                                <div class="fileupload fileupload-new col-md-6" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?= ($product->product_picture_3) ? base_url('uploads/products/thumbs/' . $product->product_picture_3) : base_url('assets/back_end/images/upload-pic-2.png') ?>" alt="<?= $product->name ?>"/>
                                                    </div>
                                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                                    <div>
                                                        <span class="btn btn-light-grey btn-file"><span class="fileupload-new"><i class="fa fa-picture-o"></i> إختيار صورة</span><span class="fileupload-exists"><i class="fa fa-picture-o"></i> تغيير</span>
                                                ...
                                                <div class="fileupload fileupload-new col-md-6" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?= ($product->product_picture_4) ? base_url('uploads/products/thumbs/' . $product->product_picture_4) : base_url('assets/back_end/images/upload-pic-2.png') ?>" alt="<?= $product->name ?>"/>
                                                    </div>
                                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                                    <div>
                                                        <span class="btn btn-light-grey btn-file"><span class="fileupload-new"><i class="fa fa-picture-o"></i> إختيار صورة</span><span class="fileupload-exists"><i class="fa fa-picture-o"></i> تغيير</span>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">
                                                        تفاصيل الملحق <span class="symbol required"></span>
                                                    </label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <button id="submit-btn" class="btn btn-info btn-block" type="submit">
                                                    حفظ الملحق <i class="fa fa-edit"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
...
//                FormValidator.init();
            ...
            $("#edit_product").submit(function () {
                ...
                $.ajax({
                    url: '<?php echo base_url() . "user/profile/do_edit_product/"; ?>',
                    type: 'POST',
                    data: formData,
                    dataType: "JSON",
