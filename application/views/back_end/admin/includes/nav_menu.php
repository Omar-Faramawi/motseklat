<ul class="nav navbar-right">
                        ...
                        <ul>
                                ...
                                <a href="javascript:;">
                                    <div class="clearfix">
                                        <div class="thread-image">
                                            <img alt="" src="./assets/back_end/images/avatar-2.jpg">
                                        </div>
                            ...
                            <li>
                                <a href="javascript:;">
                                    <div class="clearfix">
                                        <div class="thread-image">
                                            <img alt="" src="./assets/back_end/images/avatar-1.jpg">
                                        </div>
                                        <div class="thread-content">
                            ...
                            <li>
                                <a href="javascript:;">
                                    <div class="clearfix">
                                        <div class="thread-image">
                                            <img alt="" src="./assets/back_end/images/avatar-3.jpg">
                                        </div>
                                        <div class="thread-content">
                            ...
                            <li>
                                <a href="javascript:;">
                                    <div class="clearfix">
                                        <div class="thread-image">
                                            <img alt="" src="./assets/back_end/images/avatar-5.jpg">
                                        </div>
                                        <div class="thread-content">
    ...
    <li class="dropdown current-user">
        <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
            <img src="<?= base_url('assets/back_end/images/avatar-mini.png') ?>" class="circle-img" alt="">
            <span class="username"><?= $this->session->userdata("username") ?></span>
            <i class="clip-chevron-down"></i>
        </a>
        <ul class="dropdown-menu">
            <li>
                <a href="<?= base_url('admin/users/logout') ?>">
                    <i class="clip-exit"></i>
                    &nbsp;تسجيل الخروج
                </a>
            </li>
