                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    جدول يحتوي على جميع طلبات الشراء
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="hidden-xs">تاريخ الصنع</th>
        ...
        <script>
            ...
            var runDataTable = function () {
                var oTable = $('#sample_1').dataTable({
                    ...
                    "sAjaxSource": '<?php echo base_url("admin/bikes/get_all_orders/"); ?>',
                    "iDisplayStart ": 10,
                    "oLanguage": {
            ...
            function activate_order(order_id, status) {
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url("admin/bikes/activate_order/"); ?>',
                    data: {
                        order_id: order_id,
                        status: status
                    },
