...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - تعديل سعة المحرك</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    يمكنك تعديل سعة المحرك
                                </div>
                                <div class="panel-body">
                                    <h2><i class="fa fa-pencil-square teal"></i> تعديل سعة المحرك</h2>
                                    <hr>
                                    <form action="#" enctype="multipart/form-data" role="form" id="update_engine">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Start Alert Message -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="capacity" value="<?= $engine->capacity ?>" />
...
//                FormValidator.init();
            ...
            $("#update_engine").submit(function () {
                var formData = new FormData($(this)[0]);
                $.ajax({
                    url: '<?php echo base_url("admin/engines/do_edit_engine/"); ?>',
                    type: 'POST',
                    data: formData,
                    dataType: "JSON",
