...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - تعديل السلايد</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    يمكنك تعديل بيانات السلايد
                                </div>
                                <div class="panel-body">
                                    <h2><i class="fa fa-pencil-square teal"></i> تعديل السلايد</h2>
                                    <hr>
                                    <form action="#" enctype="multipart/form-data" role="form" id="update_slide">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Start Alert Message -->
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?= ($slide->picture) ? base_url('uploads/slider/thumbs/' . $slide->picture) : 'http://www.placehold.it/200x150/EFEFEF/AAAAAA?text=no+image' ?>" alt="<?= $slide->title ?>"/>
                                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="ckeditor form-control" id="description" name="description" cols="10" rows="10"><?= $slide->description ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
...
//                FormValidator.init();
            ...
            $("#update_slide").submit(function () {
                $('#description').val(CKEDITOR.instances.description.getData());
                var formData = new FormData($(this)[0]);
                $.ajax({
                    url: '<?php echo base_url("admin/slider/do_update_slide/"); ?>',
                    type: 'POST',
                    data: formData,
                    dataType: "JSON",
