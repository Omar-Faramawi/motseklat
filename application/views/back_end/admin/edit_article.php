...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - تعديل المقالة</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    يمكنك تعديل بيانات المقالة
                                </div>
                                <div class="panel-body">
                                    <h2><i class="fa fa-pencil-square teal"></i> تعديل المقالة</h2>
                                    <hr>
                                    <form action="#" enctype="multipart/form-data" role="form" id="update_article">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Start Alert Message -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">
                                                        تصنيف المقال <span class="symbol required"></span>
                                                    </label>
                                                    <select name="article_category" class="form-control">
                                                        <option>-- إختيار الفئة --</option>
                                                        <?php foreach ($categories as $category) { ?>
                                                            <option <?php if (!(strcmp($category->id, $article->category_id))) { echo "selected=\"selected\"";}?> class="text-success bold large" value="<?= $category->id ?>"><?= $category->name ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">
                                                        عنوان المقال<span class="symbol required"></span>
                                                    </label>
                                                ...
                                                <div class="col-sm-12">
                                                    <label>
                                                        قم بإختيار صورة المقال
                                                    </label>
                                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?=($article->picture)? base_url('uploads/articles/thumbs/'.$article->picture) : 'http://www.placehold.it/200x150/EFEFEF/AAAAAA?text=no+image'?>" alt="<?=$article->title?>"/>
                                                        </div>
                                                        ...
                                                        <div>
                                                            <span class="btn btn-light-grey btn-file"><span class="fileupload-new"><i class="fa fa-picture-o"></i> إختيار صورة</span><span class="fileupload-exists"><i class="fa fa-picture-o"></i> تغيير</span>
                                                                <input name="article_picture" type="file">
                                                            </span>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">
                                                        تفاصيل المقال <span class="symbol required"></span>
                                                    </label>
                                                    <textarea class="ckeditor form-control" id="article_description" name="article_description" cols="10" rows="10"><?=$article->description?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <button class="btn btn-info btn-block" type="submit">
                                                    حفظ المقال <i class="fa fa-edit"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
...
//                FormValidator.init();
            ...
            $("#update_article").submit(function () {
                $('#article_description').val(CKEDITOR.instances.article_description.getData());
                var formData = new FormData($(this)[0]);
                $.ajax({
                    url: '<?php echo base_url() . "admin/articles/do_edit_article/"; ?>',
                    type: 'POST',
                    data: formData,
                    dataType: "JSON",
