...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - إدارة السلايدر</title>
        <!-- start: META -->
        <meta charset="utf-8" />
    ...
    <body class="rtl">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="modal fade" id="confirme_remove" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">حذف السلايد</h4>
                                            <span class="modal-logo"></span>
                                        </div>
                                        <div class="modal-body">
                                            هل تريد بالتأكيد حذف هذة السلايد ؟
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                إغلاق
                                            </button>
                                            <button type="button" onclick="remove_slide()" class="btn btn-primary">
                                                موافق
                                            </button>
                                        </div>
                                    </div>
        ...
        <script>
                                                ...
                                                function remove_slide() {
                                                    $.ajax({
                                                        type: "POST",
                                                        url: '<?php echo base_url("admin/slider/remove_slide/"); ?>',
                                                        data: {
                                                            slide_id: curr_id
                                                        },
                                                        dataType: "json",
...
//                                                    App.scrollTo();
                                                ...
                                                var runDataTable = function () {
                                                    var oTable = $('#sample_1').dataTable({
                                                        ...
                                                        "bProcessing": true,
                                                        "bServerSide": true,
                                                        "sAjaxSource": '<?php echo base_url("admin/slider/get_all_slides/"); ?>',
                                                        "iDisplayStart ": 10,
                                                        "oLanguage": {
