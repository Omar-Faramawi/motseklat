                                    ...
                                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="hidden-xs">السعر بعد العرض</th>
                                                <th class="hidden-xs">تاريخ العرض</th>
                                                <th class="hidden-xs">إنتهاء العرض</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
        ...
        <script>
            ...
            var runDataTable = function () {
                var oTable = $('#sample_1').dataTable({
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": '<?php echo base_url("admin/bikes/get_all_offers/"); ?>',
                    "iDisplayStart ": 10,
                    "oLanguage": {
