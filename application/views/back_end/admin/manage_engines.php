...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - إدارة سعات المحركات</title>
        <!-- start: META -->
        <meta charset="utf-8" />
    ...
    <body class="rtl">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="modal fade" id="remove_engine" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">حذف هذا المحرك</h4>
                                            <span class="modal-logo"></span>
                                        </div>
                                        <div class="modal-body">
                                            هل تريد بالتأكيد حذف هذة المحرك ؟
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                إغلاق
                                            </button>
                                            <button type="button" onclick="remove_engine()" class="btn btn-primary">
                                                موافق
                                            </button>
                                        </div>
                                    </div>
        ...
        <script>
                                                ...
                                                function remove_engine() {
                                                    $.ajax({
                                                        type: "POST",
                                                        url: '<?php echo base_url("admin/engines/remove_engine/"); ?>',
                                                        data: {
                                                            engine_id: curr_id
                                                        },
                                                        dataType: "json",
...
//                                                    App.scrollTo();
                                                ...
                                                var runDataTable = function () {
                                                    var oTable = $('#sample_1').dataTable({
                                                        ...
                                                        "bProcessing": true,
                                                        "bServerSide": true,
                                                        "sAjaxSource": '<?php echo base_url("admin/engines/get_all_engines/"); ?>',
                                                        "iDisplayStart ": 10,
                                                        "oLanguage": {
