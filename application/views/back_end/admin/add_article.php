...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - إضافة مقال</title>
        <!-- start: META -->
        <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    يمكنك إضافة مقال جديد
                                </div>
                                <div class="panel-body">
                                    <h2><i class="fa fa-pencil-square teal"></i> إضافة مقال</h2>
                                    <hr>
                                    <form action="#" enctype="multipart/form-data" role="form" id="article_info">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Start Alert Message -->
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="ckeditor form-control" id="article_description" name="article_description" cols="10" rows="10"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
...
//                FormValidator.init();
            ...
            $("#article_info").submit(function () {
                $('#article_description').val(CKEDITOR.instances.article_description.getData());
                var formData = new FormData($(this)[0]);
                $.ajax({
                    url: '<?php echo base_url() . "admin/articles/do_add_article/"; ?>',
                    type: 'POST',
                    data: formData,
                    dataType: "JSON",
