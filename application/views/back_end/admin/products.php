...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - القطع والملحقات</title>
        <!-- start: META -->
        <meta charset="utf-8" />
    ...
    <body class="rtl">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    جدول يحتوي على جميع القطع والملحقات
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="hidden-xs">التصنيف</th>
                                                <th class="hidden-xs">تاريخ النشر</th>
                                                <th class="hidden-xs">عدد المشاهدين</th>
                                                <th class="hidden-xs">عدد المهتمين</th>
        ...
        <script>
            ...
            function activate_product(product_id, status) {
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url("admin/products/activate_product/"); ?>',
                    data: {
...
//                                                    App.scrollTo();
            ...
            var runDataTable = function () {
                var oTable = $('#sample_1').dataTable({
                    ...
                    "sAjaxSource": '<?php echo base_url("admin/products/get_all_products/"); ?>',
                    "iDisplayStart ": 10,
                    "oLanguage": {
