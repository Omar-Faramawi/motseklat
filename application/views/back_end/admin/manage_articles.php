...
<html lang="ar" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Motseklat.com - إدارة المقالات</title>
        <!-- start: META -->
        <meta charset="utf-8" />
    ...
    <body class="rtl">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="panel-body">
                                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                        <thead>
                                            <tr>
                                                <th>صورة المقال</th>
                                                <th class="hidden-xs">عنوان المقال</th>
                                                <th class="hidden-xs">نص المقال</th>
                                                <th>تاريخ النشر</th>
                                                <th class="hidden-xs">عدد المشاهدات</th>
                                                <th>قائمة المهام</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <div class="modal fade" id="remove_article" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">حذف المقالة</h4>
                                            <span class="modal-logo"></span>
                                        </div>
                                        <div class="modal-body">
                                            هل تريد بالتأكيد حذف هذة المقالة ؟
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                إغلاق
                                            </button>
                                            <button type="button" onclick="remove_article()" class="btn btn-primary">
                                                موافق
                                            </button>
                                        </div>
                                    </div>
        ...
        <script>
                                                ...
                                                function remove_article() {
                                                    $.ajax({
                                                        type: "POST",
                                                        url: '<?php echo base_url("admin/articles/remove_article/"); ?>',
                                                        data: {
                                                            article_id: curr_id
                                                        },
                                                        dataType: "json",
...
//                                                    App.scrollTo();
                                                ...
                                                var runDataTable = function () {
                                                    var oTable = $('#sample_1').dataTable({
                                                        ...
                                                        "bProcessing": true,
                                                        "bServerSide": true,
                                                        "sAjaxSource": '<?php echo base_url("admin/articles/get_all_articles/"); ?>',
                                                        "iDisplayStart ": 10,
                                                        "oLanguage": {
