    ...
    advanced_wizard: function() {
        ...
        t.length && (t.steps({
            ...
            onInit: function(i, e) {
                ...
                }), altair_uikit.reinitialize_grid_margin(), altair_forms.select_elements(t), t.find("span.switchery").remove(), altair_forms.switches(), $(".uk-accordion").on("toggle.uk.accordion", function() {
                    $window.resize()
                }), setTimeout(function() {
                    $window.resize()
                }, 100)
