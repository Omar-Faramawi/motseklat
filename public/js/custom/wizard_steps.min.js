! function(e, t) {
    ...
    function r(r, a, i) {
        ...
        i.currentIndex = l, s.each(function(a) {
            var i = e(this),
                s = o.eq(a),
                l = s.data("mode"),
                d = null == l ? Y.html : C(Y, /^\s*$/.test(l) || isNaN(l) ? l : parseInt(l, 0)),
                u = d === Y.html || s.data("url") === t ? "" : s.data("url"),
    ...
    function s(t, n) {
        ...
        var i = e('<{0} class="{1}"></{0}>'.format(t.get(0).tagName, t.attr("class"))),
            s = t._id();
    ...
    function v(e, t) {
        var n = h(e);
        return (t < 0 || t >= n.length) && $(J), n[t]
    }

    function m(e) {
        var t = e.data("uid");
        return null == t && (t = e._id(), null == t && (t = "steps-uid-".concat(K), e._id(t)), K++, e.data("uid", t)), t
    }

    function C(e, n) {
        if (Q("enumType", e), Q("keyOrValue", n), "string" == typeof n) {
            var r = e[n];
            return r === t && $("The enum key '{0}' does not exist.", n), r
        }
        if ("number" == typeof n) {
            for (var a in e)
                if (e[a] === n) return n;
            $("Invalid enum value '{0}'.", n)
        } else $("Invalid key or value type.")
    }

    function b(e, t, n) {
        return T(e, t, n, I(n, 1))
    }
    ...
    function x(e, t, n, r) {
        if ((r < 0 || r >= n.stepCount) && $(J), !(t.forceMoveForward && r < n.currentIndex)) {
            var a = n.currentIndex;
            return e.triggerHandler("stepChanging", [n.currentIndex, r]) ? (n.currentIndex = r, j(e, t, n), q(e, t, n, a), S(e, t, n), F(e, t, n), U(e, t, n, r, a, function() {
    ...
    function y(t) {
        ...
        return this.each(function() {
            ...
            t.data("options", n), t.data("state", a), t.data("steps", []), r(t, n, a), L(t, n, a), D(t, n), n.autoFocus && 0 === K && d(t, n.startIndex).focus(), t.triggerHandler("init", [n.startIndex])
        })
    }

    function _(t, n, r, a, i) {
        (a < 0 || a > r.stepCount) && $(J), i = e.extend({}, te, i), A(t, a, i), r.currentIndex !== r.stepCount && r.currentIndex >= a && (r.currentIndex++, j(t, n, r)), r.stepCount++;
        var s = t.find(".content"),
            o = e("<{0}>{1}</{0}>".format(n.headerTag, i.title)),
            l = e("<{0}></{0}>".format(n.bodyTag));
        return null != i.contentMode && i.contentMode !== Y.html || l.html(i.content), 0 === a ? s.prepend(l).prepend(o) : u(t, a - 1).after(l).after(o), O(t, r, l, a), P(t, n, r, o, a), E(t, n, r, a), a === r.currentIndex && q(t, n, r), S(t, n, r), t
    }
    ...
    function w(t) {
        ...
        t.keyCode === i.left ? (t.preventDefault(), g(n, r, a)) : t.keyCode === i.right && (t.preventDefault(), b(n, r, a))
    }
    ...
    function F(t, n, r) {
        if (r.stepCount > 0) {
            var a = r.currentIndex,
                i = v(t, a);
            if (!n.enableContentCache || !i.contentLoaded) switch (C(Y, i.contentMode)) {
                case Y.iframe:
                    t.find(".content > .body").eq(r.currentIndex).empty().html('<iframe src="' + i.contentUrl + '" frameborder="0" scrolling="no" />').data("loaded", "1");
                    break;
                case Y.async:
                    var s = u(t, a)._aria("busy", "true").empty().append(H(n.loadingTemplate, {
                    ...
                    e.ajax({
                        ...
                        s.empty().html(e)._aria("busy", "false").data("loaded", "1"), t.triggerHandler("contentLoaded", [a])
                    })
            }
        }
    }
    ...
    function S(e, t, n) {
        if (t.enablePagination) {
            ...
            if (!t.forceMoveForward) {
                ...
                i._enableAria(n.currentIndex > 0)
            }
            t.enableFinishButton && t.showFinishButtonAlways ? (r._enableAria(n.stepCount > 0), a._enableAria(n.stepCount > 1 && n.stepCount > n.currentIndex + 1)) : (r._showAria(t.enableFinishButton && n.stepCount === n.currentIndex + 1), a._showAria(0 === n.stepCount || n.stepCount > n.currentIndex + 1)._enableAria(n.stepCount > n.currentIndex + 1 || !t.enableFinishButton))
        }
    }

    function q(t, n, r, a) {
        var i = d(t, r.currentIndex),
    ...
    function E(e, t, n, r) {
        for (var a = m(e), i = r; i < n.stepCount; i++) {
            var s = a + V + i,
                o = a + W + i,
                l = a + G + i,
                d = e.find(".title").eq(i)._id(l);
            e.find(".steps a").eq(i)._id(s)._aria("controls", o).attr("href", "#" + l).html(H(t.titleTemplate, {
                index: i + 1,
                title: d.html()
    ...
    function D(e, t) {
        var n = l(e);
        e.bind("canceled" + n, t.onCanceled), e.bind("contentLoaded" + n, t.onContentLoaded), e.bind("finishing" + n, t.onFinishing), e.bind("finished" + n, t.onFinished), e.bind("init" + n, t.onInit), e.bind("stepChanging" + n, t.onStepChanging), e.bind("stepChanged" + n, t.onStepChanged), t.enableKeyNavigation && e.bind("keyup" + n, w), e.find(".actions a").bind("click" + n, k)
    }

    function M(e, t, n, r) {
        return !(r < 0 || r >= n.stepCount || n.currentIndex === r) && (N(e, r), n.currentIndex > r && (n.currentIndex--, j(e, t, n)), n.stepCount--, c(e, r).remove(), u(e, r).remove(), d(e, r).parent().remove(), 0 === r && e.find(".steps li").first().addClass("first"), r === n.stepCount && e.find(".steps li").eq(r).addClass("last"), E(e, t, n, r), S(e, t, n), !0)
    }
    ...
    function L(t, n, r) {
        var a = '<{0} class="{1}">{2}</{0}>',
            i = C(Z, n.stepsOrientation),
            s = i === Z.vertical ? " vertical" : "",
            o = e(a.format(n.contentContainerTag, "content " + n.clearFixCssClass, t.html())),
            l = e(a.format(n.stepsContainerTag, "steps " + n.clearFixCssClass, '<ul role="tablist"></ul>')),
            d = o.children(n.headerTag),
            u = o.children(n.bodyTag);
        t.attr("role", "application").empty().append(l).append(o).addClass(n.cssClass + " " + n.clearFixCssClass + s), u.each(function(n) {
            O(t, r, e(this), n)
        }), d.each(function(a) {
            P(t, n, r, e(this), a)
        }), q(t, n, r), B(t, n, r)
    ...
    function O(e, t, n, r) {
        var a = m(e),
            i = a + W + r,
            s = a + G + r;
        n._id(i).attr("role", "tabpanel")._aria("labelledby", s).addClass("body step-" + r).attr("data-step", r)._showAria(t.currentIndex === r)
    }

    function B(e, t, n) {
        if (t.enablePagination) {
            var r = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                a = '<li class="button_{0}"><a href="#{0}" role="menuitem">{1}</a></li>',
                i = "";
            t.forceMoveForward || (i += a.format("previous", t.labels.previous)), i += a.format("next", t.labels.next), t.enableFinishButton && (i += a.format("finish", t.labels.finish)), t.enableCancelButton && (i += a.format("cancel", t.labels.cancel)), e.append(r.format(t.actionContainerTag, t.clearFixCssClass, t.labels.pagination, i)), S(e, t, n), F(e, t, n)
        }
    }
    ...
    function H(e, n) {
        for (var r = e.match(/#([a-z]*)#/gi), a = 0; a < r.length; a++) {
            ...
            n[s] === t && $("The key '{0}' does not exist in the substitute collection!", s), e = e.replace(i, n[s])
        }
        return e
    }
    ...
    function P(t, n, r, a, i) {
        ...
        p._enableAria(n.enableAllSteps || r.currentIndex > i), r.currentIndex > i && p.addClass("done"), a._id(u).attr("tabindex", "-1").addClass("title"), 0 === i ? c.prepend(p) : c.find("li").eq(i - 1).after(p), 0 === i && c.find("li").removeClass("first").eq(i).addClass("first"), i === r.stepCount - 1 && c.find("li").removeClass("last").eq(i).addClass("last"), p.children("a").bind("click" + l(t), z)
    }

    function j(t, n, r) {
        n.saveState && e.cookie && e.cookie(R + m(t), r.currentIndex)
    }

    function U(t, n, r, a, i, s) {
        var o = t.find(".content > .body"),
            l = C(ee, n.transitionEffect),
        ...
        switch (l) {
            case ee.fade:
            case ee.slide:
                var f = l === ee.fade ? "fadeOut" : "slideUp",
                    h = l === ee.fade ? "fadeIn" : "slideDown";
                r.transitionElement = u, c[f](d, function() {
                    var t = e(this)._showAria(!1).parent().parent(),
                        n = p(t);
                    n.transitionElement && (n.transitionElement[h](d, function() {
                        e(this)._showAria()
            ...
            case ee.slideLeft:
                ...
                e.when(c.animate({
                    ...
                    e(this)._showAria(!1)
                }), u.css("left", b + "px")._showAria().animate({
                    left: 0
                }, d)).done(s);
                break;
            default:
    ...
    function z(t) {
        ...
        if (s === i.currentIndex) return d(r, s).focus(), !1
    }
    ...
    function Q(e, t) {
        null == t && $("The argument '{0}' is null or undefined.", e)
    }
    e.fn.extend({
        _aria: function(e, t) {
    ...
    e.fn.steps = function(t) {
        return e.fn.steps[t] ? e.fn.steps[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error("Method " + t + " does not exist on jQuery.steps") : y.apply(this, arguments)
    }, e.fn.steps.add = function(e) {
        var t = p(this);
        return _(this, f(this), t, t.stepCount, e)
    ...
    var Y = e.fn.steps.contentMode = {
        ...
        ne = e.fn.steps.defaults = {
            ...
            labels: {
                ...
                finish: "تم",
                next: "التالى <i class='material-icons'>&#xE314;</i>",
                previous: "<i class='material-icons'>&#xE315;</i> السابق ",
                loading: "Loading ..."
            }
        }
}(jQuery);